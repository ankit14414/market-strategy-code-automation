...
log = open("C:\\Users\\Ankit\\Desktop\\upstox api extras\\log.txt", "w")
execution = open("C:\\Users\\Ankit\\Desktop\\upstox api extras\\execution.txt", "w")
...
def CheckTrades():
    ...
    if time(10,21) <= now_time <= time(14,15) and CheckBalance() > 300:
        ...
        for script in bucket1:
            ...
            SMACrossOver1(historicData(script, "26/07/2019", "26/07/2019"), script)
        ...
        for script2 in bucket2:
            ...
            SMACrossOver2(historicData(script2, "26/07/2019", "26/07/2019"), script2)
